...
export default function Homepage() {
    return (
        <>
            <section className="relative lg:h-screen portrait:h-screen landscape:py-40">
                <div className="flex h-full w-full flex-col items-center justify-center gap-3 px-[5%] lg:px-[15%]">
                    ...
                    <div className="mb-5 flex flex-col items-center justify-center text-center text-[#222831] dark:text-[#DDDDDD] lg:mb-0">
