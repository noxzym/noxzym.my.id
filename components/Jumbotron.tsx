...
export const Jumbotron = function () {
    return (
        <section
            id="jumbotron"
            className="relative lg:h-screen portrait:h-screen landscape:py-40"
            data-scroll-section
        >
            <div
                className="flex h-full w-full flex-col items-center justify-center gap-3 px-[5%] lg:px-[15%]"
                data-scroll
            >
                <svg
                    viewBox="0 0 810 810"
                ...
                <div
                    className="mb-5 flex flex-col items-center justify-center text-center text-[#222831] dark:text-[#DDDDDD] lg:mb-0"
                    data-scroll
                >
                    <div
                        className="font-segoe text-xl font-bold lg:text-3xl"
                        data-scroll
                    >
                        noxzym
                    </div>
                    <div
                        className="font-segoe font-semibold lg:text-xl"
                        data-scroll
                    >
                        Lazy people who like mobile game and coding
                    </div>
                </div>
                <div
                    className="bottom-8 left-0 flex w-full flex-row items-center justify-center gap-x-5 lg:absolute lg:px-[15%]"
                    data-scroll
                >
                    {getIcon()}
                </div>
