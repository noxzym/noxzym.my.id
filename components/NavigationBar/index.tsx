        ...
        <>
            ...
            >
                <HiSun
                    ...
                    className="h-10 w-10 cursor-pointer fill-[#DDDDDD]"
                    onClick={() =>
                        renderThemeChange("light", setTheme, setThemeIcon)
                    }
                />
            </Transition>
            <Transition
            ...
            >
                <HiMoon
                    ...
                    className="h-10 w-10 cursor-pointer fill-[#222831]"
                    onClick={() =>
                        renderThemeChange("dark", setTheme, setThemeIcon)
                    }
                />
            </Transition>
        </>
